/*
    * DEVELOPMENT KIT FIXED POINT  *
*/
package modell.library;

import modell.library.stack.Stack;
...
public class MathKit {
    ...
    private String OpInfijo = "5$2*5+(2.5)";   // 3*8+5-6/2$3
    private String OpPosfijo = "";   // 38*5+623$/-
    Stack pila = new Stack(); //Creaciòn del Objecto Pila 
